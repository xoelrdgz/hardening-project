#!/usr/bin/env bash
#===============================================================================
# CIS Control: 3.3.1 - Ensure IP forwarding is disabled
# Profile: Level 1 - Server
# Automated: Yes
# Description: Prevents the system from acting as a router
#===============================================================================

set -euo pipefail

CONTROL_ID="3.3.1"
CONTROL_DESC="Ensure IP forwarding is disabled"
SYSCTL_FILE="/etc/sysctl.d/60-cis-network.conf"

declare -A PARAMS
PARAMS["net.ipv4.ip_forward"]="0"
PARAMS["net.ipv6.conf.all.forwarding"]="0"
