#!/usr/bin/env bash
#===============================================================================
# CIS Control: 3.3.3 - Ensure ICMP redirects are not accepted
# Profile: Level 1 - Server
# Automated: Yes
# Description: Prevents route poisoning attacks
#===============================================================================

set -euo pipefail

CONTROL_ID="3.3.3"
CONTROL_DESC="Ensure ICMP redirects are not accepted"
